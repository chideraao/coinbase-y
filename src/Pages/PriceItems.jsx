					...
					<section className="legal">
						<div className="container legal-disclaimer">
							<p>
								...
								any security, financial product, or instrument referenced in the
								content, and does not constitute investment advice, financial
								advice, trading advice, or any other sort of advice. Data
								presented may reflect assets traded on Basecoin’s exchange and
								select other cryptocurrency exchanges. Certain content has been
								prepared by third parties not affiliated with Basecoin Inc. or
								any of its affiliates and Basecoin is not responsible for such
