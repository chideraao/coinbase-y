								...
								{views.map((view) => {
									return (
										<a href="" key={view.abbr}>
											<div
												className="course-container card grid"
												key={view.abbr}
											>
												<div className="course-img-wrapper">
							...
							<div className="container">
								...
								<div className="icon-container grid">
									<div className="icon-item-container">
										...
										<h2>Watch videos</h2>
										<p>
											We’ve created educational videos to teach you about
									...
									<div className="icon-item-container">
										...
										<h2>Earn</h2>
										<p>
											You’ll receive crypto in your Basecoin wallet for every
											quiz you complete.
										</p>
									</div>
									<div className="icon-item-container">
										...
										<h2>Start today</h2>
										<p>
											Earn opportunities are only available for a limited time
											to a small set of customers.
										</p>
									</div>
								</div>
							</div>
