				...
				<>
						...
						<div className="container">
							<div className="grid">
								...
								<div className="info-text">
									...
									<p>
										...
										To create an open financial system for the world. To achieve
										this, we are building a team of smart, creative, passionate
										optimists, the kind of people who see opportunity where
										others see roadblocks. If this sounds like you,{" "}
							...
							<div className="grid">
								<div className="info-text">
									...
									<p>
										...
										trying to build: transparent, joyful, curious, and
										fast-moving. <a href="#">Our values</a> are a large part of
										why Basecoin is a great place to work, and why we’ve been
										successful. They are much more than words to us (and we have
							...
							<div className="grid">
								...
								<div className="info-text">
									<h2>Our mission</h2>
									<p>
										We think achieving <a href="#">our mission </a> is the
										highest leverage way to bring about more economic freedom,
										innovation, efficiency, and equality of opportunity in the
										world. Each member of our team—every engineer, designer,
										kitchen team member, lawyer, writer, support coordinator,
										recruiter, and product manager—plays an important role in
					...
					<section className="legal">
						<div className="container">
							<h1>Commitment</h1>
							<p>
								Basecoin is committed to diversity in its workforce and is proud
								to be an equal opportunity employer. Basecoin does not make
								hiring or employment decisions on the basis of race, color,
								religion, creed, gender, national origin, age, disability,
								veteran status, marital status, pregnancy, sex, gender
								...
								Basecoin will also consider for employment qualified applicants
								with arrest and conviction records in a manner consistent with
								San Francisco’s Fair Chance Ordinance and similar local laws.
							</p>
							<p>
								Basecoin is also committed to providing reasonable
							...
							<p>
								For quick access to screen reading technology compatible with
								this site click here to download a free compatible screen reader
							...
							<p>
								...
								Regulation (GDPR) and California Consumer Privacy Act (CCPA) may
								regulate the way we manage the data of job applicants. Our full
								notice outlining how data will be processed as part of the
								application procedure for applicable locations is available
								here: <a href="#">Ireland/EU</a>, <a href="#">United Kingdom</a>
								, and <a href="#">California</a>. By submitting your
